            ...
            <Grid container direction="row" justifyContent="center" alignItems="center">
                <Grid alignItems="center" item xs={12}>
                    ...
                    <Box style={{ backgroundColor: "#303F9F", height: "60px" }}>
                        ...
                        <Box>
                            <a target="_blank" href="https://github.com/Mayara-Amorim" rel="noopener noreferrer">
                                <Typography variant="subtitle2" gutterBottom style={{ color: "white" }} align="center">Mayara Amorim</Typography>
                            </a>
                        </Box>
                    </Box>
                </Grid>
